...
enum : StringId
{
    ...
    STR_POOLS = 7030,
    STR_POOL_IN_THE_WAY = 7031,
    STR_CANT_BUILD_POOL_HERE = 7032,
    STR_CANT_REMOVE_POOL_FROM_HERE = 7033,
    STR_BUILD_POOL_TIP = 7034,
    STR_POOL_TIP = 7035,
    STR_CORNER_STYLE = 7036,
    STR_POOL_SQUARE_TIP = 7037,
    STR_POOL_ANGLED_TIP = 7038,
    STR_POOL_ROUNDED_TIP = 7039,
    STR_POOL_PATH_TIP = 7040,
    STR_POOL_WATER_TIP = 7041,
    STR_POOL_RECTANGLE_TIP = 7042,
    STR_POOL_DEPTH = 7043,
    STR_TYPE = 7044,
    STR_OBJECT_SELECTION_POOL = 7045,
    STR_TILE_INSPECTOR_GROUPBOX_POOL_INFO = 7046,
