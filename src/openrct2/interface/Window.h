...
constexpr int32_t WC_TILE_INSPECTOR__TILE_INSPECTOR_PAGE_POOL = EnumValue(TileInspectorPage::Pool);
constexpr int32_t WC_TILE_INSPECTOR__WIDX_POOL_SPINNER_HEIGHT_INCREASE = 29;
constexpr int32_t WC_TILE_INSPECTOR__WIDX_POOL_SPINNER_HEIGHT_DECREASE = 30;
